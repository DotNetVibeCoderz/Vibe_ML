# Gravicode.MediaPipeNet.Models.Hand

Hand models (BlazePalm, hand landmarks, gesture embedder, canned gesture classifier) as ONNX, copied to `models/` in your output folder.
