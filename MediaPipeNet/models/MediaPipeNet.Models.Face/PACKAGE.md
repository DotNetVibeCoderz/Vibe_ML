# Gravicode.MediaPipeNet.Models.Face

Face models (BlazeFace short range, Face Mesh V2 with irises, face blendshapes) as ONNX. Copied to your output folder under `models/`, where MediaPipe.NET finds them automatically.
