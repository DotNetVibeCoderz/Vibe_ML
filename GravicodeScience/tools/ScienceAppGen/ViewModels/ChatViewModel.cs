...
public sealed partial class ChatViewModel : ObservableObject
{
    ...
    private void AddGreeting()
    {
        ...
        Messages.Add(new ChatMessage
        {
            ...
            Text = $"""
                I'm {AssistantService.FullName}. I build .NET data-science applications on the Gravicode.Science libraries, and I write the files and run the build myself rather than handing you code to paste.

                {project}

                Try asking for:
                  · a churn classifier from a CSV, with a proper train/test split
                  · a notebook that clusters the Iris dataset and plots the result
                  · Bayesian A/B testing added to this project
