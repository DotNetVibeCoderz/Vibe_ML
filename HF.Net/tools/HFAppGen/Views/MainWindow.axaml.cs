...
public partial class MainWindow : Window
{
    ...
    protected override void OnOpened(EventArgs e)
    {
        ...
        // The shell reopens the last project, but it cannot open a file - the editor is driven from
        // here. Without this, relaunching lands on a populated explorer beside an empty editor
        // saying "Nothing open", which reads as though the project failed to load.
        if (Shell?.Projects.ProjectRoot is { } root && Shell.Editor.Documents.Count == 0)
        {
            OpenFirstSourceFile(root);
        }
    }
